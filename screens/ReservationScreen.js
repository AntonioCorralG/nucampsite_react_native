...
const ReservationScreen = () => {
  ...
  const presentLocalNotifications = async (reservationDate) => {
      ...
      <Animatable.View animation="zoomIn" duration={2000} delay={1000}>
        ...
        <View style={styles.formRow}>
          <Button
                ...
                [
                  ...
                  },
                  {
                    ...
                    onPress: () => {
                      ...
                      presentLocalNotifications(date.toLocaleDateString('en-US'));
                      resetForm();
                    },
                  },
                ],
            ...
            color="#5637DD"
            accessibilityLabel="Tap me for search for available accessibility features"
          />
        </View>
      </Animatable.View>
    </ScrollView>
